...
I ran some quick exploratory tools on the data to identify characteristics like seasonality and trend, before working out the most appropriate and most concise ARIMA models to use.
